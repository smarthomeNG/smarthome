...
.. note::
    ...
    Diese Release Notes sind ein Arbeitsstand.
     ...
     - Berücksichtigt sind Commits im smarthome Repository bis incl. 4. Februar 2022
       (Merge pull request #467 from onkelandy/datatables Datatables update and fixes)
     - Berücksichtigt sind Commits im plugins Repository bis incl. 10. Februar 2022
       (Sonos: Update SoCo base framework to version 0.26.1)

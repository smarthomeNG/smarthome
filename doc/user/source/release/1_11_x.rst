...
.. only:: develop_branch
    ...
    .. note::
        ...
        Diese Release Notes sind ein Arbeitsstand des **develop** Branches.
         ...
         - Berücksichtigt sind Commits im smarthome Repository bis incl. 27. Januar 2025
           (modules.mqtt: allow paho_mqtt 2.x)
         - Berücksichtigt sind Commits im plugins Repository bis incl. 27. Januar 2025
           (Merge pull request #996 from onkelandy/denon)
...
* Workflows:
  ...
  * Ceckout fallback to plugins/develop

...
_commands_example_flat = {
    ...
    'cmd': {
        ...
        #
        # With the SDPCommandStr class, the following substitutions are available:
        ...
        #
        # With the SDPCommandParseStr class, the following additional substitutions
        ...
        # Value extraction is implemented only in SDPCommandParseStr as of now
        #
        ...
        'item_attrs': {
            ...
            # create "ex_read_initial: true" entry
            ...
            #      ex_read_groups: ['l1.l2.l3', 'l1.l2.l3.l4']
            ...
            'read_groups': [
                ...
                {'name': '<read group 2>', 'trigger': '..path.to.other.item'},
            ],
        },
    }
}
...
_commands_example_nested = {
    'level1a': {
        'level2a': {'cmd1': {'contents': 'like first example'}},
        'level2b': {'cmd1': {'as': 'above'}, 'cmd2': {'still': 'unchanged'}},
    }
}
...
lookups = {'table1': {1: 'foo', 2: 'bar', 3: 'baz'}, 'table2': {'a': 'lorem', 'b': 'ipsum', 'c': 'dolor'}}
...
lookups = {
    'ALL': {'table1': {1: 'foo', 2: 'bar', 3: 'baz'}, 'table2': {'a': 'lorem', 'b': 'ipsum', 'c': 'dolor'}},
    'model1': {'table1': {1: 'boo', 2: 'far', 3: 'faz'}, 'table3': {1.0: 'one', 2.0: 'two', 3.0: 'three', 3.14: 'pi'}},
    'model2': {'table3': {1.0: 'one', 2.0: 'two', 3.0: 'three', 3.14: 'pi'}},
}
...
item_templates = {'template1': {'foo': 'bar', 'foof': 'barf'}, 'template2': {'foop': 'barp', 'floop': 'blarp'}}

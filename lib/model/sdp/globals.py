...
PLUGIN_ATTR_CONN_RETRY_SUSPD = (
    'retry_suspend'  # after this number of failed connect cycles, activate suspend mode (if enabled)
)
...
CONN_NET_TCP_JSONRPC = (
    'net_tcp_jsonrpc'  # JSON RPC via persistent TCP client connection with async callback for responses
)
